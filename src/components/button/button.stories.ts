...
export const Primary: StoryObj = {
  render: () => html`
    <button class="cx-btn__primary cx-btn__lg cx-mr-6">Primary button</button>
...
export const Secondary: StoryObj = {
  render: () => html`
    <button class="cx-btn__secondary cx-btn__lg cx-mr-6">Secondary button</button>
...
export const Tertiary: StoryObj = {
  render: () => html`
    <button class="cx-btn__tertiary cx-btn__lg cx-mr-6">Tertiary button</button>
...
export const Danger: StoryObj = {
  render: () => html`
    <button class="cx-btn__danger cx-btn__lg cx-mr-6">Danger button</button>
